...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark">
        <div class="container">
                ...
                <h3><span class="bg-main">เข้าสู่ระบบ</span></h3>
           
           
                <ul class="navbar-nav ml-auto">
                    <li class="nav-link">
                        <a class="btn btn-primary btn-block btn-login" <?php echo anchor("member/log","Login");?></a>
                    </li>
                    <li class="nav-link">
                        <a class="btn btn-primary btn-block btn-register" <?php echo anchor("member/addform","ลงชื่อเข้าใช้"); ?></a>
                    </li>
        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading ">ระบบลงชื่อเข้าใช้ห้องประชุม</h3>
